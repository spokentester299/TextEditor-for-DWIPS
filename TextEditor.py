...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    self.root = root
    # Title of the window
    self.root.title("WWS | DWIPS - Text Workstation")
    # Window Geometry
    ...
    # Initializing Status
    self.status.set("OPERATIONAL TEXTGEN")
    # Creating Menubar
  ...
  def newfile(self,*args):
    ...
    self.settitle()
    # updating status
    self.status.set("DWIPS - New Text Product Created | Product ID = Unidentified ID")
#Defining Open File Funtion
  def openfile(self,*args):
    ...
    try:
      ...
      if self.filename:
        ...
        self.settitle()
        # Updating Status
        self.status.set("DWIPS - Product Live")
    except Exception as e:
      messagebox.showerror("DWIPS - Unable To Open Product",e)
  ...
  def savefile(self,*args):
    ...
    try:
      ...
      if self.filename:
        ...
        self.settitle()
        # Updating Status
        self.status.set("DWIPS - Product Saved")
      else:
        self.saveasfile()
    except Exception as e:
      messagebox.showerror("DWIPS - Unable To Save Product",e) 
  ...
  def saveasfile(self,*args):
    ...
    try:
      ...
      self.settitle()
      # Updating Status
      self.status.set("YOUR PRODUCT HAS BEEN SAVED")
    except Exception as e:
      messagebox.showerror("Exception",e)
  # Defining Exit Funtion
  def exit(self,*args):
    op = messagebox.askyesno("WARNING"," YOUR PRODUCT IS NOT SAVED! ARE YOU SURE YOU WISH TO EXIT THE PRODUCT?")
    if op>0:
      self.root.destroy()
    else:
      return
  ...
  def undo(self,*args):
    ...
    try:
      ...
      if self.filename:
        ...
        self.settitle()
        # Updating Status
        self.status.set("COMMAND SUCESSFUL")
      else:
        # Clearing Text Area
        self.txtarea.delete("1.0",END)
        # Updating filename as None
